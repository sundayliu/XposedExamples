  ...
  extends Service
{
  ...
  private final IInAppBillingService.Stub mBinder = new IInAppBillingService.Stub()
  {
      ...
      throws RemoteException
    {
      ...
      localIntent.setClass(InAppBillingService.this.getApplicationContext(), BuyActivity.class);
      ...
      paramAnonymousString1 = new DbHelper(InAppBillingService.this.mContext, paramAnonymousString1).getItems();
      ...
      localBundle.putParcelable("BUY_INTENT", PendingIntent.getActivity(InAppBillingService.this.getApplicationContext(), 0, localIntent, 134217728));
      return localBundle;
    }
      ...
      throws RemoteException
    {
      ...
      localIntent.putExtra("payload", paramAnonymousString4);
      localIntent.putExtra("Type", paramAnonymousString3);
      paramAnonymousList.putParcelable("BUY_INTENT", PendingIntent.getActivity(InAppBillingService.this.getApplicationContext(), 0, localIntent, 134217728));
      ...
      throws RemoteException
    {
      ...
      Object localObject = new DbHelper(InAppBillingService.this.mContext, paramAnonymousString1).getItems();
      ...
      for (;;)
      {
        try
        {
          if ((!InAppBillingService.this.mSetupDone) && (!InAppBillingService.this.skipSetupDone)) {
            InAppBillingService.this.connectToBilling(paramAnonymousString1);
          }
          new Bundle().putInt("RESPONSE_CODE", 0);
          if ((InAppBillingService.this.mSetupDone) && (InAppBillingService.this.mService != null))
          {
            boolean bool = InAppBillingService.this.skipSetupDone;
            if (bool) {}
          }
        }
        catch (Exception localException2)
        {
          ...
          localObject2 = "0." + l;
          Object localObject6 = new DbHelper(InAppBillingService.this.mContext, paramAnonymousString1).getItems().iterator();
        ...
        try
        {
          ...
          localObject3 = InAppBillingService.this.mService.getSkuDetails(paramAnonymousInt, paramAnonymousString1, paramAnonymousString2, paramAnonymousBundle);
  ...
  public void connectToBilling(final String paramString)
  {
    ...
    mServiceConn = new ServiceConnection()
    {
      public void onServiceConnected(ComponentName paramAnonymousComponentName, IBinder paramAnonymousIBinder)
      {
        ...
        InAppBillingService.this.mService = IInAppBillingService.Stub.asInterface(paramAnonymousIBinder);
        try
        {
          int i = InAppBillingService.this.mService.isBillingSupported(3, paramString, "inapp");
          if (i != 0)
          {
            System.out.println("bill error:" + i);
            InAppBillingService.this.skipSetupDone = true;
            return;
          }
          if (InAppBillingService.this.mService.isBillingSupported(3, paramString, "subs") == 0) {}
...
/* Location:              /Users/sundayliu/Desktop/gamecheat/com.android.vending.billing.InAppBillingService.LACK-1/classes-dex2jar.jar!/com/google/android/finsky/billing/iab/InAppBillingService.class
