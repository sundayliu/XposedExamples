...
public class Integrate_Dalvik_Code_Dialog
{
  ...
  public Dialog onCreateDialog()
  {
    ...
    try
    {
      ...
      ((TextView)localObject).setText(Utils.getColoredText(Utils.getText(2131165781), "#00FF00", ""));
      ((TextView)localObject).setTextAppearance(listAppsFragment.frag.getContext(), listAppsFragment.getSizeText());
      localObject = new AlertDlg(listAppsFragment.frag.getContext());
      ((AlertDlg)localObject).setIcon(2130837548);
      ((AlertDlg)localObject).setTitle(Utils.getText(2131165782));
...
/* Location:              /Users/sundayliu/Desktop/gamecheat/com.android.vending.billing.InAppBillingService.LACK-1/classes-dex2jar.jar!/com/android/vending/billing/InAppBillingService/LACK/dialogs/Integrate_Dalvik_Code_Dialog.class
