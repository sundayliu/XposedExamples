...
public class Create_Apk_Ads_Dialog
{
  Dialog dialog = null;
  String resultFile = "";
  ...
  {
    System.out.println("Create apk ads Dialog create.");
    ...
    if (listAppsFragment.pli != null)
    {
      ...
      localObject2 = new File(this.resultFile + listAppsFragment.pli.name.replaceAll(" ", ".").replaceAll("/", ".") + (String)localObject1 + ".crk.ADS.Removed.apk");
      localObject3 = new File(this.resultFile + listAppsFragment.pli.pkgName + (String)localObject1 + ".crk.ADS.Removed.apk");
      if ((((File)localObject2).exists()) || (((File)localObject3).exists()))
      {
        if ((((File)localObject2).exists()) && (listAppsFragment.getConfig().getInt("apkname", 0) == 0)) {
          listAppsFragment.str = Utils.getText(2131165390) + " " + listAppsFragment.pli.name + " " + Utils.getText(2131165392) + "\n" + this.resultFile + "\n\n" + Utils.getText(2131165396) + "\n" + listAppsFragment.pli.name.replaceAll(" ", ".").replaceAll("/", ".") + (String)localObject1 + ".crk.ADS.Removed.apk" + Utils.getText(2131165393);
        }
        if ((((File)localObject3).exists()) && (listAppsFragment.getConfig().getInt("apkname", 0) == 1)) {
          listAppsFragment.str = Utils.getText(2131165390) + " " + listAppsFragment.pli.name + " " + Utils.getText(2131165392) + "\n" + this.resultFile + "\n\n" + Utils.getText(2131165396) + "\n" + listAppsFragment.pli.pkgName + (String)localObject1 + ".crk.ADS.Removed.apk" + Utils.getText(2131165393);
        }
    ...
    else
    {
      new AlertDlg(listAppsFragment.frag.getContext()).setTitle(Utils.getText(2131165186)).setCancelable(true).setIcon(2130837548).setPositiveButton(Utils.getText(2131165587), null).setNeutralButton(Utils.getText(2131165476), new DialogInterface.OnClickListener()
      {
        ...
        {
          listAppsFragment.patchAct.show_file_explorer(Create_Apk_Ads_Dialog.this.resultFile);
        }
...
/* Location:              /Users/sundayliu/Desktop/gamecheat/com.android.vending.billing.InAppBillingService.LACK-1/classes-dex2jar.jar!/com/android/vending/billing/InAppBillingService/LACK/dialogs/Create_Apk_Ads_Dialog.class
