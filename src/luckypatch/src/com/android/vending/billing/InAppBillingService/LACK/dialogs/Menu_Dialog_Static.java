...
public class Menu_Dialog_Static
{
  ...
  public Dialog onCreateDialog()
  {
    try
    {
      ...
      ((AlertDlg)localObject).setPositiveButton(2131165662, new DialogInterface.OnClickListener()
      {
        public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
        {
          listAppsFragment.frag.runId(2131165662);
        }
      });
      if (listAppsFragment.menu_adapt != null)
      {
        listAppsFragment.menu_adapt.setNotifyOnChange(true);
        ((AlertDlg)localObject).setAdapterNotClose(true);
...
/* Location:              /Users/sundayliu/Desktop/gamecheat/com.android.vending.billing.InAppBillingService.LACK-1/classes-dex2jar.jar!/com/android/vending/billing/InAppBillingService/LACK/dialogs/Menu_Dialog_Static.class
