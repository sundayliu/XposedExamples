    ...
    implements IInAppBillingService
  {
      ...
      throws RemoteException
    {
      ...
      case 2: 
        ...
        if (paramParcel1.readInt() != 0)
        {
          ...
          paramParcel1 = getSkuDetails(paramInt1, (String)localObject, str, paramParcel1);
          paramParcel2.writeNoException();
      ...
      paramParcel1 = getBuyIntentToReplaceSkus(paramInt1, str, (List)localObject, paramParcel1.readString(), paramParcel1.readString(), paramParcel1.readString());
      paramParcel2.writeNoException();
      if (paramParcel1 != null)
      {
        paramParcel2.writeInt(1);
      ...
      implements IInAppBillingService
    {
        ...
        throws RemoteException
      {
        ...
        //   100: aload 8
        //   102: aload_3
        //   103: invokevirtual 85	android/os/Parcel:readStringList	(Ljava/util/List;)V
        //   106: aload 8
        ...
        //   123: astore_2
        //   124: aload 8
        //   126: invokevirtual 61	android/os/Parcel:recycle	()V
        //   129: aload 7
        //   131: invokevirtual 61	android/os/Parcel:recycle	()V
        //   134: aload_2
        //   135: athrow
        // Local variable table:
        //   start	length	slot	name	signature
        ...
        //   0	136	3	paramList	List<String>
        //   0	136	4	paramString2	String
        //   0	136	5	paramString3	String
        //   0	136	6	paramString4	String
        //   3	127	7	localParcel1	Parcel
        //   8	117	8	localParcel2	Parcel
        // Exception table:
        //   from	to	target	type
        //   10	100	123	finally
        //   100	106	123	finally
...
/* Location:              /Users/sundayliu/Desktop/gamecheat/com.android.vending.billing.InAppBillingService.LACK-1/classes-dex2jar.jar!/com/android/vending/billing/IInAppBillingService.class
