...
public class Common
{
  ...
  public static final boolean JB_MR1_NEWER;
  public static final boolean JB_MR2_NEWER;
  public static final boolean JB_NEWER;
  public static final boolean KITKAT_NEWER;
  public static final int LATEST_ANDROID_RELEASE = 21;
  public static final boolean LOLLIPOP_NEWER;
  ...
  public static final int mBase = 0;
  ...
  static
  {
    ...
    label149:
    label154:
    for (String str = "com.android.server.devicepolicy.DevicePolicyManagerService";; str = "com.android.server.DevicePolicyManagerService")
    {
      DEVICEPOLICYMANAGERSERVICE = str;
      return;
      bool1 = false;
      break;
      bool1 = false;
...
/* Location:              /Users/sundayliu/Desktop/gamecheat/com.android.vending.billing.InAppBillingService.LACK-1/classes-dex2jar.jar!/com/chelpus/Common.class
