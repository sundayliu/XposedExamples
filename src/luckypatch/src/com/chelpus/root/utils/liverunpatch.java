  ...
  public static void main(String[] paramArrayOfString)
  {
    ...
    if ((arrayOfByte4.length == arrayOfByte3.length) && (arrayOfByte1.length == arrayOfByte2.length) && (arrayOfByte2.length > 3) && (arrayOfByte1.length > 3))
    {
      ...
      if (m < localObject1.length)
      {
        ...
        if ((localObject1[m].contains("**")) || (localObject1[m].contains("??")))
        {
          localObject1[m] = "00";
          arrayOfByte3[m] = 1;
          label220:
          arrayOfByte1[m] = Integer.valueOf(localObject1[m], 16).byteValue();
          if ((!localObject2[m].contains("**")) && (!localObject2[m].contains("??"))) {
            break label313;
          }
          localObject2[m] = "00";
          arrayOfByte4[m] = 0;
      ...
      if (j == 0) {
        localObject2 = dalvikDexIn.replace("zamenitetodelo", paramArrayOfString[0]);
      }
    }
    for (;;)
    {
      ...
      try
      {
        ...
        localObject1 = new File(((String)localObject2).replace("-1", ""));
        if (paramArrayOfString.exists()) {
          localObject1 = paramArrayOfString;
        }
        localObject2 = ((String)localObject2).replace("data@app", "mnt@asec").replace(".apk@classes.dex", "@pkg.apk@classes.dex");
...
/* Location:              /Users/sundayliu/Desktop/gamecheat/com.android.vending.billing.InAppBillingService.LACK-1/classes-dex2jar.jar!/com/chelpus/root/utils/liverunpatch.class
