  ...
  public static void main(String[] paramArrayOfString)
  {
    ...
    catch (FileNotFoundException paramArrayOfString)
    {
      ...
      for (;;)
      {
        ...
        return;
        Utils.copyFile((File)localObject1, new File(((File)localObject1).getAbsolutePath().replace("classes", "backup")));
...
/* Location:              /Users/sundayliu/Desktop/gamecheat/com.android.vending.billing.InAppBillingService.LACK-1/classes-dex2jar.jar!/com/chelpus/root/utils/backup.class
